...
const connectMongoDB = async () => {
  try {
    const mongoUri =
      process.env.MONGODB_URI || "mongodb://localhost:27017/dzinza_search";
...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "Advanced search capabilities for genealogy data including people, records, and historical documents",
      contact: {
        name: "Dzinza Team",
