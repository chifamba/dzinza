...
async def create_notification(
    ...
    await collection.insert_one(db_notification.prepare_for_mongodb())
...
async def get_notification_by_id(
    ...
    notification_id_binary = Binary.from_uuid(notification_id)
    doc = await collection.find_one({"_id": notification_id_binary, "user_id": user_id})
...
async def mark_notification_as_read(
    ...
    updated_doc = await collection.find_one_and_update(
        {"_id": notification_id_binary, "user_id": user_id, "read": False}, # Only update if currently unread
...
async def delete_notification(
    ...
    from bson import Binary
    notification_id_binary = Binary.from_uuid(notification_id)
    result = await collection.delete_one({"_id": notification_id_binary, "user_id": user_id})
