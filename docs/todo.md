...
- [x] **T-3.4.3** — Implement cultural name parsing
...
- [x] **T-4.2.1** — Implement AI moderation service (Keyword check implemented)
- [x] **T-4.2.2** — Wire to `admin_moderation_service`

### 4.3 Backup & Recovery

- [x] **T-4.3.1** — Implement backup service (pg_dump, neo4j-admin dump, mongodump)
- [x] **T-4.3.2** — Implement automated DB dumps (scheduled in main.go)
- [x] **T-4.3.3** — Write Dockerfile + add to `docker-compose.yml`

### 4.4 External Integrations

- [x] **T-4.4.1** — Implement generic integration service (Stubs implemented)
