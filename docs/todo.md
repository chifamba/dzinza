...
- [x] **T-2.2.2** — Implement Trust Score calculation engine (Partial: uses mock data)
...
- [x] **T-2.3.2** — Implement Suggestion model and workflow (Partial: simplified logic)
...
- [x] **T-2.4.2** — Implement duplicate detection algorithm (Partial: basic exact match)
...
- [x] **T-2.5.3** — Implement content moderation (Partial: fire-and-forget AI call)
