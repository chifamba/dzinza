...
*(For a detailed list of all originally planned features, please refer to historical project documentation like `JULES_TASKS.md` in the legacy docs section of the repository.)*
...
*(A more detailed architecture description can be found in `/docs/ARCHITECTURE.md`)*
...
2.  **Environment Setup:**
    ...
    *(Refer to `/docs/ARCHITECTURE.md` or `docs/ENVIRONMENT_CONFIGURATION.md` (legacy) for more detailed environment configuration information.)*
...
3.  **Access API Documentation (Swagger/OpenAPI):**
    ...
    *(Replace `<GATEWAY_PORT>` with the actual port your API Gateway is running on, typically 3001 as per the default `.env.example`. Individual service direct ports like `8004` are examples and may vary.)*
...
*(For more specific guidelines, refer to any `CONTRIBUTING.md` file that might be present in the repository or specific instructions from project maintainers.)*
